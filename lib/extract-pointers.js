define(['exports', 'module', 'laxar-patterns', './to-json-pointer'], function (exports, module, _laxarPatterns, _toJsonPointer) {
   /**
   ...
   module.exports = extractPointers;

   function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { 'default': obj }; }

   var _patterns = _interopRequireDefault(_laxarPatterns);

   var _toJsonPointer2 = _interopRequireDefault(_toJsonPointer);
   ...
   function mapPromise(object, callback) {
      if (object instanceof Array) {
         ...
         var _ret = (function () {
            var result = {};
            return {
               v: Promise.all(Object.keys(object).map(function (key) {
   ...
   function extractPointers(object, pointers, callback) {
      return deepMapPromise(pointers, function (pointer) {
         var value = _patterns['default'].json.getPointer(object, (0, _toJsonPointer2['default'])(pointer));
...
//# sourceMappingURL=extract-pointers.js.map
